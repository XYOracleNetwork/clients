...
describeIf(hasMongoDBConfig())('DeterministicArchivist', () => {
  ...
  beforeAll(async () => {
    ...
    userAccount = await Account.create({ privateKey: toUint8Array('69f0b123c094c34191f22c25426036d6e46d5e1fab0a04a164b3c1c2621152ab').buffer })

    // 0xdaddab0e0468c920bd5aff4b14fd94c20a598055
    moduleAccount = await Account.create({ privateKey: toUint8Array('9c9637dc07ce9956190c028677f5195a8fb425e9927bf2e48fe39a1c55cf050a').buffer })

    // 0xbabe1d55e51844ea1cdc6b4dcbb649bb08e3cc3c
    randomAccount = await Account.create({ privateKey: toUint8Array('3c17e038c8daeed7dfab9b9653321523d5f1a68eadfc5e4bd501075a5e43bbcc').buffer })
